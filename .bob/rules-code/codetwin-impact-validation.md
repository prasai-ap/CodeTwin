...
2. Independently inspect the changed code, its predicted dependents, tests, and relevant files outside the predicted graph. Treat the AST result as deterministic prediction evidence, not as proof of semantic impact.
