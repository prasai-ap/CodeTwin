...
6. Call `codetwin.run_targeted_tests` with the same analysis ID. Report the test output and final status from CodeTwin; do not claim Safe to Merge if a test failed or possible impact remains unresolved.
